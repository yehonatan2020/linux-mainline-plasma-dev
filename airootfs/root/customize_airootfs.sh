...
#sudo pacman --noconfirm --nodeps -U root/boost/boost-libs-1.80.tar.zst && sudo pacman --noconfirm --nodeps -U root/boost-1.80.tar.zst
sudo sed -i -e 'IgnorePkg   = boost-libs' /etc/pacman.conf  
